...
import UIKit
// firebase i neden appDelegate e import ettik. neden başka bir klasör değil.
import Firebase
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        // Bu kısım ilk başta çağrılır.(didFinishLaunchingWithOptions methodu) Bu kısım çağrıldıktan sonra uygulamada diğer safhalara geçilir. Bu satırın Firebase i başlatması için mutlaka yazılması gerekir
